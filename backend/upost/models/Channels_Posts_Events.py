...
class ContentChannel(models.Model):
    channel_id = models.AutoField(db_column='Channel_ID', primary_key=True)  # Field name made lowercase.
    ...
    channel_name = models.CharField(db_column='Channel_Name', max_length=50, unique=True)  # Field name made lowercase.
    deleted_flag = models.BooleanField(db_column='Deleted_Flag', default=False,
                                       blank=True)  # Field name made lowercase.
    creation_date = models.DateField(db_column='Creation_Date', auto_now_add=True)  # Field name made lowercase.
    deletion_date = models.DateField(db_column='Deletion_Date', blank=True, null=True)  # Field name made lowercase.
...
class Post(models.Model):
    ...
    post_description = models.CharField(db_column='Post_description', max_length=500)  # Field name made lowercase.
    ...
    deleted_flag = models.BooleanField(db_column='Deleted_Flag', default=False, blank=True)
...
class PostEvent(models.Model):
    post = models.OneToOneField(Post, on_delete=models.CASCADE, primary_key=True, related_name="post_event")
    ...
    planned_start_date = models.DateField(db_column='Planned_start_date')  # Field name made lowercase.
    planned_start_time = models.TimeField(db_column='Planned_start_time')  # Field name made lowercase.
    planned_end_date = models.DateField(db_column='Planned_end_date')  # Field name made lowercase.
    planned_end_time = models.TimeField(db_column='Planned_end_time')  # Field name made lowercase.
