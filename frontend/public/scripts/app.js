...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function handleDeleteOptions() {
            ...
            //         options: []
            //     };
            // });  // Explicity returning an object

            this.setState(function () {
                return { options: [] };
            }); // syntax for implicitly returning an object
        }
    }, {
...
var AddOption = function (_React$Component2) {
    ...
    _createClass(AddOption, [{
        ...
        value: function handleAddOption(e) {
            // e to find referenced event
            e.preventDefault(); // prevents default behaviour of rerendering entire page. 

            var option = e.target.elements.option.value.trim(); // elements in form referenced by name 
...
//         </div>
//     );
// };   // syntax for stateless functional component
