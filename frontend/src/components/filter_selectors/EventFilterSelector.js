        ...
        return (
            <div>
                <div className="input-group">
                        ...
                        <div className="input-group__column">
                            ...
                            <div className="input-group__item">
                                <select
                                    className="select"
                                    defaultValue={
                                        this.props.filters.hasIncentive
                                    }
                                    onChange={this.handleHasIncentiveChange}
                                >
                                    <option value="all">Show All</option>
                                    <option value="hasIncentive">
                                        Has Incentive
                                    </option>
                                    <option value="noIncentive">
                                        No Incentive
                                    </option>
                                </select>
                            </div>
                    ...
                    {this.props.filters.hasIncentive === "hasIncentive" &&
                        !this.props.foodSpecific && (
                            <div className="input-group__column">
                                Incentive Type:
                                <div className="input-group__item">
                                    <select
                                        className="select"
                                        defaultValue={
                                            this.props.filters.incentiveType
                                        }
                                        onChange={
                                            this.handleIncentiveTypeChange
                                        }
                                    >
                                        <option value="">Show All</option>
                                        {this.props.incentiveTypes.map(
                                            (incentive) => {
                                                return (
                                                    <option
                                                        key={incentive}
...
const mapStateToProps = (state) => ({
    ...
    communities: state.communities.communities.map(
        (community) => community.community_name
    ),
    incentiveTypes: state.incentiveTypes.incentiveTypes.map(
        (incentiveType) => incentiveType.incentive_name
    ),
    dietOptions: state.dietOptions.dietOptions.map(
        (diet_option) => diet_option.diet_option
    )
});
...
const mapDispatchToProps = (dispatch) => ({
    ...
    setCommunityFilter: (communities) =>
        dispatch(setCommunityFilter(communities)),
    setHasIncentiveFilter: (hasIncentive) =>
        dispatch(setHasIncentiveFilter(hasIncentive)),
    setIncentiveTypeFilter: (incentiveTypes) =>
        dispatch(setIncentiveTypeFilter(incentiveTypes)),
    setDietOptionsFilter: (dietOptions) =>
        dispatch(setDietOptionsFilter(dietOptions)),
