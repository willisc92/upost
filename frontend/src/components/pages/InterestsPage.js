...
export class InterestsPage extends React.Component {
  ...
  markSelectedInterests = () => {
    ...
    for (let i = 0; i < interestsWithSelected.length; i++) {
      if (
        this.props.userInterests.includes(interestsWithSelected[i].interest_tag)
      ) {
      ...
      <div>
        <div className="page-header">
          <div className="content-container">
            ...
            <p>
              Please choose 3 or more Interests. When we know what are are
              passionate about we can find better events for you
            </p>
          </div>
        </div>
        <div className="content-container">
